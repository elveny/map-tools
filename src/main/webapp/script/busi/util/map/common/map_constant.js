...
/**地图类型[1:google,2:baidu,3:amap]**/
MAP.CONSTANT.MAPTYPE = {};
MAP.CONSTANT.MAPTYPE.GOOGLE = '1';
MAP.CONSTANT.MAPTYPE.BAIDU = '2';
MAP.CONSTANT.MAPTYPE.AMAP = '3';

// 绘图类型
MAP.CONSTANT.DRAWINGTYPE = {};
/**画点**/
MAP.CONSTANT.DRAWINGTYPE.DRAWING_MARKER = "DRAWING_MARKER";
/**画圆**/
MAP.CONSTANT.DRAWINGTYPE.DRAWING_CIRCLE = "DRAWING_CIRCLE";
/**画线**/
MAP.CONSTANT.DRAWINGTYPE.DRAWING_POLYLINE = "DRAWING_POLYLINE";
/**画多边形**/
MAP.CONSTANT.DRAWINGTYPE.DRAWING_POLYGON = "DRAWING_POLYGON";
/**画矩形**/
MAP.CONSTANT.DRAWINGTYPE.DRAWING_RECTANGLE = "DRAWING_RECTANGLE";